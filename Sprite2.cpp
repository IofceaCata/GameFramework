...
Sprite2::Sprite2(int imageID, int maskID)
{
...
Sprite2::Sprite2(const char *szImageFile, const char *szMaskFile)
{
...
Sprite2::Sprite2(const char *szImageFile, COLORREF crTransparentColor)
{
	mhImage = (HBITMAP)LoadImage(g_hInst, szImageFile, IMAGE_BITMAP, 0, 0, LR_CREATEDIBSECTION | LR_LOADFROMFILE);
...
void Sprite2::setBackBuffer(const BackBuffer *pBackBuffer)
{
...
AnimatedSprite2::AnimatedSprite2(const char *szImageFile, const char *szMaskFile, const RECT& rcFirstFrame, int iFrameCount)
	: Sprite2(szImageFile, szMaskFile)
{
...
void AnimatedSprite2::SetFrame(int iIndex)
{
...
LaserSprite2::LaserSprite2(int imageID, int maskID)
{
	// Load the bitmap resources.
	mhImage = LoadBitmap(g_hInst, MAKEINTRESOURCE(imageID));
	mhMask = LoadBitmap(g_hInst, MAKEINTRESOURCE(maskID));
...
LaserSprite2::LaserSprite2(const char *szImageFile, const char *szMaskFile)
{
	mhImage = (HBITMAP)LoadImage(g_hInst, szImageFile, IMAGE_BITMAP, 0, 0, LR_CREATEDIBSECTION | LR_LOADFROMFILE);
	mhMask = (HBITMAP)LoadImage(g_hInst, szMaskFile, IMAGE_BITMAP, 0, 0, LR_CREATEDIBSECTION | LR_LOADFROMFILE);
...
LaserSprite2::LaserSprite2(const char *szImageFile, COLORREF crTransparentColor)
{
	mhImage = (HBITMAP)LoadImage(g_hInst, szImageFile, IMAGE_BITMAP, 0, 0, LR_CREATEDIBSECTION | LR_LOADFROMFILE);
...
void LaserSprite2::update(float dt)
{
	// Update the sprites position.
...
void LaserSprite2::setBackBuffer(const BackBuffer *pBackBuffer)
{
	mpBackBuffer = pBackBuffer;
	if (mpBackBuffer)
	{
...
void LaserSprite2::drawTransparent()
{
	if (mpBackBuffer == NULL)
		return;
